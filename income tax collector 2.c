...
int main()
{
 ...
 int choice;
 printf("WELCOME! MA'AM,ACCORDING TO THE TASK GIVEN TO US THE OUTPUT IS AS 
FOLLOWING.PLEASE ENTER THE NUMBER OF THE MENUS WRITTEN INFRONT OF 
EVERY MENU RESPECTIVELY.WE ARE GIVEN THE TASK TO MAKE INCOME TAX 
CALCULATOR.CHOOSE THE MODULES FROM THE MENU ");
 do
 {
 printf("\nMenu:\n");
 printf("1. Add Record\n");
